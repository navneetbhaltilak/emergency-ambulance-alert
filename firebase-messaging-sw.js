...
messaging.onBackgroundMessage((payload) => {
  // Messages are now data-only (see app.py) so there's no payload.notification
  // to auto-display — title/body are carried in payload.data instead, and we
  // build the notification ourselves.
  const title = payload.data?.title || "Ambulance Alert";
